...
let endPoints = {
  ...
  unpreprocessedPeopleGet:
    baseUrl + "api/credential/preprocess/getPeoplePreprocess",
...
export function upload(file, onSuccess, onFailure) {
  const headers = {
    Authorization: "Bearer " + getToken(),
...
export function startComparingProcess(onSuccess, onFailure) {
  const headers = {
    Authorization: "Bearer " + getToken()
  }
  ...
  axios({
    method: "POST",
    url: endPoints.startComparingProcess,
    headers: headers,
    crossDomain: true
  })
    .then(function(response) {
...
export function getComparingProcessInfo(onSuccess, onFailure) {
  const headers = {
    Authorization: "Bearer " + getToken()
  }
